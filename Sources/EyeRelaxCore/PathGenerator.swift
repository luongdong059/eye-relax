...
public enum PathGenerator {
    ...
    /// Hash tất định → [0,1) (SplitMix64 rút gọn). Public để các hiệu ứng
    /// render thuần theo thời gian (pháo bông…) dùng chung nguồn ngẫu nhiên.
    public static func hash01(_ n: UInt64, seed: UInt64) -> Double {
